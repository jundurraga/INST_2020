...
[Try this simulator](http://myselph.de/hodgkinHuxley.html)


Set IRand to zero, tInjStop to 50, and IDC to 10  and  **investigate what is the effect on the neuron's threshold and spike morphology when changing**


- pulse duration
- pulse amplitude
- maximum sodium conductance (GNaMax)
- maximum potassium conductance (GKMax)
- maximum leak conductance (Gm)
